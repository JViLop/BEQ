# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 14:51:47 2024
...
from utils.model_reader_step import EQ_model
...
steps = [52,44,37]
for step in steps:
    kinematic_model = EQ_model('Tohoku','kinematic',step,'binary',(9,24),29,nrows_skip=2,model_file_shape=(866,1000000),sampling=True, nsamples=100)

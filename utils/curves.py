...
class Curves():
    ...
    def save_curves_no_strike(self):
        ...
        model = {'ysrc':ysrc,'m':self.m()['m'],'err_m':self.m()['err_m']} 
        displacements = {'ystn_d':ystn_d,'tn':self.dis(1)['d'],'err_tn':self.dis(1)['err_d'],'v':self.dis(2)['d'],'err_v':self.dis(2)['err_d']} 
        ...
        file_dir = os.path.join(self.make_dirs(file='summary_curves'),file_m)
        ...
        file_dir = os.path.join(self.make_dirs(file='summary_curves'),file_disp)
        ...
        file_dir = os.path.join(self.make_dirs(file='summary_curves'),file_stress)

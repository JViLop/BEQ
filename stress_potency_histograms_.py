...
def observables(name,parameters,shape,samples,dir_folder= 'histograms',rake=90, RotAngle=None,th=None):
    ...
    data = h5py.File(f'stress_change_5000_samples/{name}_Stress change_nsamples_{samples}.h5')
...
def plot_all_hist_observables(EQs,samples= 5000,thr = [0.1,0.2],folder = 'stress_change_samples_5000'):
